<section class="relative w-screen h-[50vh] left-1/2 -translate-x-1/2" aria-label="Hero sezione introduttiva">
  <img src="{{ $dataHero->immagine_hero['url'] }}" class="absolute inset-0 w-full h-full object-cover" alt="" aria-hidden="true">
  ...
  <div class="absolute inset-0 flex items-center justify-center px-4 text-white text-center">
    <div class="flex flex-col items-center">
      ...
      <a href="#shop" class="mt-6 bg-[#45752c] hover:bg-[#386322] text-white font-semibold px-6 py-3 rounded shadow transition">
        {{ $ctaText }}
      </a>
    </div>
  </div>
