        <style>
            ...
            @keyframes glowPulse {
                0% {
                    box-shadow: 0 0 0 0 rgba(69, 117, 44, 0.55), 0 0 0 6px rgba(69, 117, 44, 0.20), 0 0 0 12px rgba(69, 117, 44, 0.10);
                }

                70% {
                    box-shadow: 0 0 0 8px rgba(69, 117, 44, 0.00), 0 0 0 16px rgba(69, 117, 44, 0.00), 0 0 0 24px rgba(69, 117, 44, 0.00);
                }

                100% {
                    box-shadow: 0 0 0 0 rgba(69, 117, 44, 0.00), 0 0 0 0 rgba(69, 117, 44, 0.00), 0 0 0 0 rgba(69, 117, 44, 0.00);
                }
            }
        ...
        }" x-cloak x-show="$store.cart ? $store.cartReady : true" class="fixed z-[9999]"
