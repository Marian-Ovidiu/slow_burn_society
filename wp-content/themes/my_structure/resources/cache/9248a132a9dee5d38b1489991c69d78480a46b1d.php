...
<?php $__env->startSection('content'); ?>
    ...
    <div x-data="{ modalOpen: false, selected: null, modalOpen2: false, selected2: null }">
        <?php if($dataHero): ?>
            <?php echo $__env->make('components.heroSection', [
                'dataHero' => $dataHero,
            ], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
        <?php endif; ?>
        <?php if($data): ?>
            <?php echo $__env->make('components.cardProdottoEvidenza', [
                'data' => $data,
                'products' => $products,
            ], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
        <?php endif; ?>
            ...
            <div class="space-y-4 md:grid md:grid-cols-3 md:gap-6 md:space-y-0">
                <?php $__currentLoopData = $latest; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="flex items-center gap-4 bg-white rounded shadow p-3 cursor-pointer transition hover:shadow-md"
                        @click="modalOpen2 = true; selected2 = <?php echo e(json_encode($item)); ?>">
                        <img src="<?php echo e($item['image']); ?>" class="w-16 h-16 object-cover rounded" alt="<?php echo e($item['name']); ?>">
                        <div>
                            <h3 class="text-sm font-semibold"><?php echo e($item['name']); ?></h3>
                            <p class="text-xs text-gray-500">€<?php echo e($item['price']); ?></p>
                        </div>
                    </div>
        ...
        <section class="px-4 md:px-8 lg:px-16 py-6 bg-gray-50">
            ...
            <div class="space-y-4 md:grid md:grid-cols-3 md:gap-6 md:space-y-0">
                <?php $__currentLoopData = [['name' => 'Luca R.', 'text' => 'Servizio rapido e prodotti top, come da Slow Burn Society!'], ['name' => 'Giulia S.', 'text' => 'Ho trovato tutto per le mie sigarette rollate, super!'], ['name' => 'Franco P.', 'text' => 'Comodo, veloce, economico. Consigliato!']]; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $review): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="bg-white p-4 rounded shadow">
                        <p class="text-sm italic">“<?php echo e($review['text']); ?>”</p>
                        <p class="text-xs text-right text-gray-500 mt-2">— <?php echo e($review['name']); ?></p>
                    </div>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            </div>
        </section>
...
<?php echo $__env->make('layouts.mainLayout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\MAMP\htdocs\slow_burn_society\wp-content\themes\my_structure\resources\views/home.blade.php ENDPATH**/ ?>